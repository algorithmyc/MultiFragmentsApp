package date.intec.be.multifragmentsapp;
...
import date.intec.be.multifragmentsapp.fragments.FragmentDetail;
import date.intec.be.multifragmentsapp.fragments.FragmentPerson;
